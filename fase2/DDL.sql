CREATE TYPE TIPO_ESTADO AS ENUM ('COMPLETO', 'EM DESENVOLVIMENTO', 'NÃO INICIADO');
...
CREATE TABLE ATIVIDADE(
    ...
    DATACRIACAO DATE,
    DONOEMAIL   VARCHAR(30)  NOT NULL,
    PID         INTEGER      NOT NULL,
    DATALIMITE  DATE         NOT NULL,
    FOREIGN KEY (PID)        REFERENCES PROJETO(ID),
    FOREIGN KEY (DONOEMAIL)  REFERENCES DESENVOLVEDOR(EMAIL)
);
